                    ...
                    <div class="col-md-4 col-sm-4 navicons-topbar">
                        <ul>
                            ...
                            <li>
                                ...
                                <?= Html::dropDownList('language', Yii::$app->language, ['ru_RU' => 'Русский', 'en_EN' => 'English']) ?>
                        ...
                        <nav class="main-menu">
                            ...
                            if (Yii::$app->user->isGuest) {
                                ...
                                $menuItems[] = '<li>'
                                    ...
                                    . Html::submitButton(
                                        Yii::t("menu", "Logout") .'(' . Yii::$app->user->identity->username . ') <i class="fa fa-sign-out"></i>', ['class' => 'btn btn-link logout']
                                    )
                                    . Html::endForm()
                                    . '</li>';
                            }
